        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <h5>所有文章</h5>
               <form action="adminAll.do" method="post">
              ...
              <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <c:forEach var="forumVO" items="${forumVOList}" varStatus="status" begin="${pageStart}" end="${pageEnd}">
                      <tr>
                        <td>${forumVO.postNo}</td>
                        <td>${forumVO.memberNo}</td>
                        <td>${forumVO.topicNo}</td>
            <td>
                          <button class="openButton btn_style">展開標題</button>
                          <div class="titlePopup pop">
                            <div class="titleContainer">
                              <textarea rows="3" cols="25" readonly>${forumVO.title}</textarea><br>
...
<td>
        	            ...
        	            <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${forumVO.postTime}"  /></td>
        	               	<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${forumVO.modificationTime}"  /></td>
                      </tr>
                       </c:forEach>
                  </tbody>
                                  </table>
...
<td>
        	            ...
        	            <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${forumVO.replyTime}"  /></td>
        	               	<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${forumVO.modificationTime}"  /></td>
                      </tr>
                       </c:forEach>          
                      </tbody>
           ...
           <c:if test="${not empty forumVOList}">
              <c:if test="${param.page>1}">
                <a href="adminAll.do?page=${param.page-1}&listname=${listname}">上一頁 </a>
              </c:if>
              <c:if test="${param.page<totalPage}">
                <a href="adminAll.do?page=${param.page+1}&listname=${listname}">下一頁</a>
              </c:if>
              <div style="float:right">
                <a href="adminAll.do?page=1&listname=${listname}">至第一頁</a>
                <span>第${param.page}頁 / 共${totalPage}頁</span>
                <a href="adminAll.do?page=${totalPage}&listname=${listname}">至最後一頁</a>
              </div>
            </c:if>
            <!--/ Basic Bootstrap Table -->
            <hr class="my-5" />
