							...
							<div class="account-wrapper__content">
								<form class="custom-form">
									<div class="custom-form__btn">
										<a href="login.html">
											<button type="button" class="btn submit-btn">登入</button>
									</div>
									<div class="form-group custom-form__input"></div>
									<div class="custom-form__btn">
										<a href="signup.html"></a>
										<button type="button" class="btn submit-btn">註冊</button>
									</div>
								</form>
							</div>
					...
					<div class="custom-form custom-form--box sing-up">
						...
						<form action="MemberLoginServlet" method="post">
							<div class="form-group custom-form__input">
								<label for="inputEmail">Email 信箱</label> <input
									type="email" class="form-control ltr" id="inputEmail"
							...
							<div class="row">
								<div class="col-md-6 custom-form__input custom-form__btn">
							...
							<div class="custom-form__footer">
								...
								<div class="custom-form__footer--link">
									...
									<div class="row">
										<div class="col-md-6 custom-form__input custom-form__btn">
											<a href="./member/signup.html" class="btn submit-btn">註冊會員</a>
										</div>
										<div class="col-md-6 custom-form__input custom-form__btn">
											<a href="./designer/signup.html" class="btn submit-btn">註冊設計師</a>
										</div>
									</div>
								</div>
							</div>
