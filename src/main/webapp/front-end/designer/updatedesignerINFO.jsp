		...
		<div class="row align-items-center py-4 px-xl-5">
			<div class="align-item-center-right">
				<a href="#" type="button"
					...
					data-bs-toggle="modal" data-bs-target="#loginModal">登出</a>
			</div>
				...
				<nav
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav py-0">
							<div id="selfedit" style="width: 200px"><a  href="<%=request.getContextPath()%>/front-end/designer/updatedesignerINFO.jsp" class="nav-item nav-link"><b>編輯簡介</b></a></div>
							<div id="ordermanage" style="width: 200px"><a  href="<%=request.getContextPath()%>/front-end/designer/findDesigner.jsp" class="nav-item nav-link"><b>訂單管理</b></a></div>
