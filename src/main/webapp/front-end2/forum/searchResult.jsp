                    ...
                    <c:forEach var="forumPostVO" items="${resultList}" varStatus="status">
                        ...
                        <div class="table-row">
                            ...
                            <div class="searchsubjects AutoSkip">
                                <a
                                    href="posts.do?topicNo=${forumPostVO.topicNo}&postNo=${forumPostVO.postNo}"><b>${forumPostVO.title}</b></a>
                                <br>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <div class="searchcontent AutoSkip" style="height:200px">${forumPostVO.content}
                                    </div>
                                </c:otherwise>
                            </c:choose>
