...
public class SendContract extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if("sendcontract".equals(action)) {
			...
			Integer orderPhase = Integer.valueOf(req.getParameter("contractphase"));
...
//				if (filename != null && filename.length() != 0 && part.getContentType() != null) {
			...
			DesignerOrderPhaseVO designerOrderPhaseVO = designerOrderPhaseSvc.insertDesignerOrderPhase(OrderNo, orderPhase, amount,contractAtt);
